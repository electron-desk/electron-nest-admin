import { defineComponent, onUpdated, reactive, ref, toRaw } from "vue";
import MyIcon from "../../../components/MyIcon";
import * as antIcons from "@ant-design/icons-vue";
import { doAddPermission } from "../../../api/permission";
import { message } from "ant-design-vue";
import useAdminStore from "../../../store/admin";
/*
 * @Author: 最爱白菜吖 <1355081829@qq.com>
 * @Date: 2022-08-26 07:00:31
 * @LastEditTime: 2022-08-29 00:56:57
 * @LastEditors: 最爱白菜吖
 * @FilePath: \vue3-admin\src\pages\permission\components\AddPermission.tsx
	...
	setup(props, { emit }) {
		...
		function addPermission() {
			formRef.value.validate().then(() => {
				doAddPermission(formState).then((res) => {
					if (res.success) {
						emit("cancel", true);
				...
				v-slots={{
					extra: () => (
						<a-space>
							...
							<a-button type="primary" onClick={addPermission}>
								新增
							</a-button>
						</a-space>
					),
